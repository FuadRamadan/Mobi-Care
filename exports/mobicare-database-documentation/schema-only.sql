...
\restrict oPGTT6dqqhG5GdlDAZcQigw6T6O3LikYUGM2v4conGsIxaTRRMBKBYmR1nqTNHp
...
CREATE TRIGGER audit_log_no_update_delete BEFORE DELETE OR UPDATE ON public.audit_log FOR EACH ROW EXECUTE FUNCTION public.audit_log_block_mutation();
...
\unrestrict oPGTT6dqqhG5GdlDAZcQigw6T6O3LikYUGM2v4conGsIxaTRRMBKBYmR1nqTNHp
