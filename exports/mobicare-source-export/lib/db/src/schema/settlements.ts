...
export const settlementsTable = pgTable("settlements", {
  ...
  uniqueIndex("settlements_pharmacy_period_uq").on(t.pharmacyId, t.periodStart, t.periodEnd),
]);
...
export const courierSettlementsTable = pgTable("courier_settlements", {
  ...
  uniqueIndex("courier_settlements_courier_period_uq").on(t.courierId, t.periodStart, t.periodEnd),
]);
