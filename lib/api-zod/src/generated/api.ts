 ...
 */
export const requestPatientEmailPasswordResetBodyEmailMax = 320;


export const requestPatientEmailPasswordResetBodyEmailRegExp = new RegExp('^[^\\s@]+@[^\\s@]+\\.[^\\s@]+$');


export const RequestPatientEmailPasswordResetBody = zod.object({
  "email": zod.string().max(requestPatientEmailPasswordResetBodyEmailMax).regex(requestPatientEmailPasswordResetBodyEmailRegExp)
})

export const requestPatientEmailPasswordResetResponseRetryAfterSecondsMin = 0;



export const RequestPatientEmailPasswordResetResponse = zod.object({
  "message": zod.string(),
  "retryAfterSeconds": zod.number().min(requestPatientEmailPasswordResetResponseRetryAfterSecondsMin),
  "passwordPolicy": zod.object({
  "id": zod.number(),
  "maxPasswordAgeDays": zod.number().describe('Number of days before a password must be changed'),
  "passwordExpiryWarningDays": zod.number().describe('Number of days before expiry when pharmacies may proactively change their password'),
 ...
 */
export const verifyPatientEmailPasswordResetOtpBodyEmailMax = 320;


export const verifyPatientEmailPasswordResetOtpBodyEmailRegExp = new RegExp('^[^\\s@]+@[^\\s@]+\\.[^\\s@]+$');
export const verifyPatientEmailPasswordResetOtpBodyOtpRegExp = new RegExp('^[0-9]{6}$');


export const VerifyPatientEmailPasswordResetOtpBody = zod.object({
  "email": zod.string().max(verifyPatientEmailPasswordResetOtpBodyEmailMax).regex(verifyPatientEmailPasswordResetOtpBodyEmailRegExp),
  "otp": zod.string().regex(verifyPatientEmailPasswordResetOtpBodyOtpRegExp)
})




export const VerifyPatientEmailPasswordResetOtpResponse = zod.object({
 ...
 */
export const resetPatientEmailPasswordBodyResetTokenMin = 32;
export const resetPatientEmailPasswordBodyResetTokenMax = 512;

export const resetPatientEmailPasswordBodyNewPasswordMax = 200;



export const ResetPatientEmailPasswordBody = zod.object({
  "resetToken": zod.string().min(resetPatientEmailPasswordBodyResetTokenMin).max(resetPatientEmailPasswordBodyResetTokenMax),
  "newPassword": zod.string().min(1).max(resetPatientEmailPasswordBodyNewPasswordMax)
})

export const ResetPatientEmailPasswordResponse = zod.object({
  "message": zod.string()
})
