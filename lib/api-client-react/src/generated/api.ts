...
import type {
  ...
  PatientEmailInput,
  PatientEmailOtpInput,
  PatientEmailPasswordResetRequested,
  PatientNotification,
  PatientOrder,
  PatientOrderInput,
...
export const getRequestPatientEmailPasswordResetUrl = () => {




  return `/api/patient/auth/forgot-password`
}

/**
 * @summary Send a password reset code to a patient's registered email
 */
export const requestPatientEmailPasswordReset = async (patientEmailInput: PatientEmailInput, options?: Parameters<typeof customFetch>[1]): Promise<PatientEmailPasswordResetRequested> => {

  return customFetch<PatientEmailPasswordResetRequested>(getRequestPatientEmailPasswordResetUrl(),
  {
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(patientEmailInput)
  }
);}
...
export const getRequestPatientEmailPasswordResetMutationOptions = <TError = ErrorType<void>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof requestPatientEmailPasswordReset>>, TError,{data: BodyType<PatientEmailInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof requestPatientEmailPasswordReset>>, TError,{data: BodyType<PatientEmailInput>}, TContext> => {

const mutationKey = ['requestPatientEmailPasswordReset'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof requestPatientEmailPasswordReset>>, {data: BodyType<PatientEmailInput>}> = (props) => {
          const {data} = props ?? {};

          return  requestPatientEmailPasswordReset(data,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type RequestPatientEmailPasswordResetMutationResult = NonNullable<Awaited<ReturnType<typeof requestPatientEmailPasswordReset>>>
    export type RequestPatientEmailPasswordResetMutationBody = BodyType<PatientEmailInput>
    export type RequestPatientEmailPasswordResetMutationError = ErrorType<void>

    /**
 * @summary Send a password reset code to a patient's registered email
 */
export const useRequestPatientEmailPasswordReset = <TError = ErrorType<void>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof requestPatientEmailPasswordReset>>, TError,{data: BodyType<PatientEmailInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof requestPatientEmailPasswordReset>>,
        TError,
        {data: BodyType<PatientEmailInput>},
        TContext
      > => {
      return useMutation(getRequestPatientEmailPasswordResetMutationOptions(options));
    }

export const getVerifyPatientEmailPasswordResetOtpUrl = () => {
...
/**
 * @summary Verify a patient email reset code and receive a single-use reset token
 */
export const verifyPatientEmailPasswordResetOtp = async (patientEmailOtpInput: PatientEmailOtpInput, options?: Parameters<typeof customFetch>[1]): Promise<PatientPasswordResetToken> => {

  return customFetch<PatientPasswordResetToken>(getVerifyPatientEmailPasswordResetOtpUrl(),
  {
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(patientEmailOtpInput)
  }
);}
...
export const getVerifyPatientEmailPasswordResetOtpMutationOptions = <TError = ErrorType<void>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof verifyPatientEmailPasswordResetOtp>>, TError,{data: BodyType<PatientEmailOtpInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof verifyPatientEmailPasswordResetOtp>>, TError,{data: BodyType<PatientEmailOtpInput>}, TContext> => {

const mutationKey = ['verifyPatientEmailPasswordResetOtp'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof verifyPatientEmailPasswordResetOtp>>, {data: BodyType<PatientEmailOtpInput>}> = (props) => {
          const {data} = props ?? {};

          return  verifyPatientEmailPasswordResetOtp(data,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type VerifyPatientEmailPasswordResetOtpMutationResult = NonNullable<Awaited<ReturnType<typeof verifyPatientEmailPasswordResetOtp>>>
    export type VerifyPatientEmailPasswordResetOtpMutationBody = BodyType<PatientEmailOtpInput>
    export type VerifyPatientEmailPasswordResetOtpMutationError = ErrorType<void>

    /**
 * @summary Verify a patient email reset code and receive a single-use reset token
 */
export const useVerifyPatientEmailPasswordResetOtp = <TError = ErrorType<void>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof verifyPatientEmailPasswordResetOtp>>, TError,{data: BodyType<PatientEmailOtpInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof verifyPatientEmailPasswordResetOtp>>,
        TError,
        {data: BodyType<PatientEmailOtpInput>},
        TContext
      > => {
      return useMutation(getVerifyPatientEmailPasswordResetOtpMutationOptions(options));
    }

export const getResetPatientEmailPasswordUrl = () => {




  return `/api/patient/auth/reset-password`
}

/**
 * @summary Reset a patient password using a verified email reset token
 */
export const resetPatientEmailPassword = async (patientResetPasswordInput: PatientResetPasswordInput, options?: Parameters<typeof customFetch>[1]): Promise<MessageResponse> => {

  return customFetch<MessageResponse>(getResetPatientEmailPasswordUrl(),
  {
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(patientResetPasswordInput)
  }
);}
...
export const getResetPatientEmailPasswordMutationOptions = <TError = ErrorType<void>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof resetPatientEmailPassword>>, TError,{data: BodyType<PatientResetPasswordInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof resetPatientEmailPassword>>, TError,{data: BodyType<PatientResetPasswordInput>}, TContext> => {

const mutationKey = ['resetPatientEmailPassword'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof resetPatientEmailPassword>>, {data: BodyType<PatientResetPasswordInput>}> = (props) => {
          const {data} = props ?? {};

          return  resetPatientEmailPassword(data,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type ResetPatientEmailPasswordMutationResult = NonNullable<Awaited<ReturnType<typeof resetPatientEmailPassword>>>
    export type ResetPatientEmailPasswordMutationBody = BodyType<PatientResetPasswordInput>
    export type ResetPatientEmailPasswordMutationError = ErrorType<void>

    /**
 * @summary Reset a patient password using a verified email reset token
 */
export const useResetPatientEmailPassword = <TError = ErrorType<void>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof resetPatientEmailPassword>>, TError,{data: BodyType<PatientResetPasswordInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof resetPatientEmailPassword>>,
        TError,
        {data: BodyType<PatientResetPasswordInput>},
        TContext
      > => {
      return useMutation(getResetPatientEmailPasswordMutationOptions(options));
    }
